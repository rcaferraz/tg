...
% Se preferir, crie um arquivo à parte e o inclua via \include{}
\abstract
As happened after the improvement of the print media occurred in the fifteenth century at the beginning of the Renaissance, the Internet turned information access easier and faster for a wider group of people. As social networks and media sharing became mainstream, any individual connected to this network was able to generate content and make theirs fellows more informed, taking from the hands of the big companies of communication the oligopoly on information. That change is bringing a deep impact in culture, as the access to arts and literature of all the world was facilitated, and also in politics, since people with ideas and ideals in common can communicate in real time, even without knowing each other, doing a better work in monitoring the government and possibly going out to the streets, to express their insatisfactions.

It is the nature of law to evolve slower than technology. Only after being aware of the problem, the discussion of the best solutions can be started. Then after achieving a conclusion, a law can be implemented, if necessary, and it also lasts a little. At the moment, it is possible to see some points where the Internet can be improved by new governing laws. It is the nature of the market to go in search of profit in every way possible, and as Jérémie Zimmerman said before ``more and more often our data becomes a commodity that can be used not only to make things easier but also to control our lives and profit from us''. It is necessary to watch the abuses of the market and try to find solutions, possibly in the form of new laws.

Furthermore, the massive adoption of new communication mediums by the society brought great powers to a restricted group. Those responsible for the network infrasctructure and the major service and content providers have power over what information we have access, possibly censoring citizens and also are able to gain knowledge of everything we do on the network, which includes our private conversations and even our thoughts that we express through search engines like Google.

With the intention to make society more aware of these problems, accelerating the process of regulating our network consciously, this work lists the most common ways that governments use to censor and monitor citizens. But while nothing is done, and also to those who are under a non-decmocratic government, some techniques can be used to circumvent censorship and surveillance, which will also be briefly presented in this work.
