...
No entanto, governos podem criar obstáculos para utilização de proxies. Em primeiro lugar, países que queiram implantar censura, em geral têm na sua lista de IPs bloqueados não só os provedores de conteúdo, mas também servidores que funcionam como proxy. E se o IP do proxy está bloqueado, não haverá como utilizá-lo, naturalmente. Em segundo lugar, o governo pode deixar intencionalmente alguns proxies abertos apenas com a intenção
...
\end{center}
\caption[Captura de tela de um navegador acessando um Proxy Web]{Legenda imagem PHProxy} \label{fig_phproxy}
\end{figure}
...
\end{center}
\caption[Captura de tela de uma página com uma lista de proxies SOCKS]{Legenda imagem idcloak} \label{fig_idcloak}
\end{figure}
