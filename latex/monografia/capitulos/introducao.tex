...
\end{center}
\caption[Página com transmissão do Mídia NINJA ao vivo]{Utilizando apenas um aplicativo para celular e conexão 3G, foi possível transmitir para centenas de pessoas a ocupação da Câmara de Vereadores do Recife por manifestantes reivindicando passe livre de ônibus. O celular do "ninja" (como alguns chamam os jornalistas que transmitem nesses moldes) perdia o sinal ao se aproximar muito da Câmara. Por isso, muitas vezes a transmissão era interrompida. No momento, a Mídia NINJA era a fonte de informação mais atualizada sobre a ocupação da câmara.}\label{fig_midianinjape}
\end{figure}
