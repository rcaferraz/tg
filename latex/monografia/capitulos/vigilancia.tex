...
\section{Transmissão voluntária dos dados}
...
\section{Com quem você se comunica}

É possível descobrir não os dados, mas o que você acessa, através da descoberta das suas requisições a algum servidor DNS.
