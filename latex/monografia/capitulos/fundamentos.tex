...
Provedor de Acesso Serviços e Informações da Rede Internet (Internet Service Provider - ISP):
...
Peering privado e Ponto de Troca de Tráfego:
...
Ponto de Troca de Tráfego (PTT) ou Internet Exchange Point (IXP):
