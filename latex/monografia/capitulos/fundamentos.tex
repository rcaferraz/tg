...
\subsection{Como funciona a Web e servidores de nomes}
Para acessar um Website, o Google por exemplo, primeiro é enviada um pacote ao computador (também chamado de servidor) que contém a página procurada. O conteúdo deste pacote é um pedido, requisitando a página inicial. O Website então responde com outros pacotes, contendo a página, que ao chegar no computador, é exibida ao usuário. Quando o usuário clica em algum link do site, uma nova requisição é enviada, que por sua vez é respondida novamente com outra página. A navegação na Web funciona basicamente desta forma: requisições dos usuários e respostas dos servidores Web, em forma de páginas.
