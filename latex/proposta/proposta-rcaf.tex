...
\usepackage{paralist} % Usado para listas "compactenum"
\usepackage{placeins} % Usado para \FloatBarrier (impede que uma table flutue após a barreira estabelecida)
